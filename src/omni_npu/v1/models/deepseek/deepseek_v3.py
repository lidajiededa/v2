...
"""Inference-only Deepseek V3 and GLM 5 models."""
    ...
    def __init__(
        ...
        if config.n_shared_experts is None or self.is_fusion_moe_shared_experts_enabled:
            ...
            self.shared_experts = DeepseekV2MLP(
                ...
                disable_tp=not model_extra_config.parall_config.enable_share_expert_tp,
    ...
    def forward(
        ...
        if get_pp_group().is_first_rank:
            if inputs_embeds is not None:
                ...
                hidden_states = self.embed_tokens(input_ids, enable_scatter=model_extra_config.parall_config.ena_seq_parallel)
            residual = None
        else:
        ...
        kw = {"y_transform": "AG"} if model_extra_config.parall_config.ena_seq_parallel else {}
        hidden_states, _ = self.norm(hidden_states, residual, **kw)
            ...
            for param_name, weight_name, shard_id in stacked_params_mapping:
                ...
                for j in range(num_chunks):
                    ...
                    for mapping in expert_params_mapping:
                        ...
                        # Skip unused quantization parameter for inference mode
                        if name == "rot.weight":
                            continue
