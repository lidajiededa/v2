...
from vllm.model_executor.models.qwen2_vl import Qwen2VLMultiModalDataParser, Qwen2VLProcessingInfo
from omni_npu.v1.models.qwen.qwen3 import Qwen3ForCausalLM, Qwen3Model
