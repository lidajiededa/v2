...
class Hifloat8LinearMethod(LinearMethodBase):
    ...
    def process_weights_after_loading(self, layer):
        ...
        # layer.weight_scale = torch.nn.Parameter(layer.weight_scale.data.squeeze(-1).float(), requires_grad=False)
    ...
    def apply(self, layer, x, bias=None):
        ...
        y = torch_npu.npu_quant_matmul(
            # x1=x, x2=layer.weight, scale=layer.weight_scale, pertoken_scale=x_scale, bias=bias,
